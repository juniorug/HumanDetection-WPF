...
namespace FaceTrackingBasics
{
    ...
    public partial class FaceTrackingViewer : UserControl, IDisposable
    {
        ...
        private readonly Dictionary<int, int> skeletonIdMap = new Dictionary<int, int>();
        ...
        private class SkeletonFaceTracker : IDisposable
        {
            ...
            public void DrawFaceModel(DrawingContext drawingContext, int personIndex)
            {
                ...
                SolidColorBrush[] colors = new SolidColorBrush[6] { Brushes.Blue, Brushes.Yellow, Brushes.Pink, Brushes.Green, Brushes.Pink, Brushes.Salmon };
            ...
            internal void OnFrameReady(KinectSensor kinectSensor, ColorImageFormat colorImageFormat, byte[] colorImage, DepthImageFormat depthImageFormat, short[] depthImage, Skeleton skeletonOfInterest)
            {
                ...
                if (this.faceTracker != null)
                {
                    ...
                    if (this.lastFaceTrackSucceeded)
                    {
                        ...
                        PrintTrackedData(skeletonOfInterest);
                    }
                }
            }

            private void PrintTrackedData(Skeleton skeletonOfInterest)
            {
                SkeletonPoint currentPosition = skeletonOfInterest.Position;
                int index = skeletonOfInterest.TrackingId;
                String pattern = "0.000";
                String distance = GetDistance(currentPosition).ToString(pattern);
                String x = Math.Round(currentPosition.X, 3).ToString(pattern);
                String y = Math.Round(currentPosition.Y, 3).ToString(pattern);
                String z = Math.Round(currentPosition.Z, 3).ToString(pattern);
                Debug.WriteLine(string.Format("[Person ID: {0}] [Distance: {1} m] [Coordinates: [X: {2}], [Y: {3}], [Z: {4}]]", index, distance,x,y,z));
            }


            private double GetDistance(SkeletonPoint point)
            {
